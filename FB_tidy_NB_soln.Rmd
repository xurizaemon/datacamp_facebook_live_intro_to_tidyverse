...
This is odd to me because the two high-paying fares are both male, but in the following graph there is a high-fare male and female each?

```{r message = FALSE}
# Scatter plot of Age vs Fare
ggplot(passengers, aes(x = Sex, y = Fare)) +
  geom_point()
```
